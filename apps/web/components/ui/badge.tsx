...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  en_instalacion: 'bg-orange-50 text-orange-700 border border-orange-200',
  completado: 'bg-cyan-50 text-cyan-700 border border-cyan-200',
  cobrado: 'bg-teal-50 text-teal-700 border border-teal-200',
